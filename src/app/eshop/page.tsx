  ...
  return (
    <>
      ...
      <main className="bg-night">
        <section className="relative overflow-hidden bg-gradient-to-br from-night via-primary-950/20 to-accent-950/20 pt-32 pb-16">
          <div className="relative z-10 mx-auto w-full max-w-[1680px] px-4 sm:px-6 lg:px-8 2xl:px-10">
            <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-3xl">
                <div className="mb-6 inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm font-medium text-accent-300 shadow-sm">
            ...
            <div className="mt-10 grid grid-cols-1 gap-4 md:grid-cols-3">
              {[
                ...
                <div key={item.title} className="rounded-2xl border border-white/10 bg-night-800 p-5 shadow-sm backdrop-blur">
                  <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl bg-primary-950/50 border border-primary-500/20">
        ...
        <section className="border-y border-white/10 bg-night-800/40 py-14">
          <div className="mx-auto w-full max-w-[1680px] px-4 sm:px-6 lg:px-8 2xl:px-10">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
              <div>
                <p className="data-label mb-4">Jak to funguje</p>
                <h2 className="heading-2 mt-2 text-white">Aby zákazník nekupoval stejné věci dvakrát</h2>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-6 inline-flex items-center gap-2 font-semibold text-accent-400 transition-colors hover:text-accent-300"
                >
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                {howItWorks.map((item, index) => (
                  <div key={item.title} className="rounded-2xl border border-white/10 bg-night-700 p-5">
                    <div className="mb-4 flex h-9 w-9 items-center justify-center rounded-full bg-accent-500/20 text-sm font-bold text-accent-300">
                      {index + 1}
                    </div>
        ...
        <section id="nabidka" className="section-padding bg-night">
          <div className="mx-auto w-full max-w-[1680px] px-4 sm:px-6 lg:px-8 2xl:px-10">
            <div className="mb-10 flex items-end justify-between gap-6">
              <div>
                <p className="data-label mb-4">Nabídka</p>
                <h2 className="heading-2 mt-2 text-white">Katalog sad, kitů a projektů</h2>
              </div>
              <p className="hidden max-w-xl text-right text-sm leading-6 text-slate-400 lg:block">
        ...
        <section className="bg-night-800 py-16 text-white">
          <div className="mx-auto w-full max-w-[1680px] px-4 sm:px-6 lg:px-8 2xl:px-10">
            <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
              <div>
                <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm font-medium text-slate-300">
              ...
              <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
                {featuredProjects.map((project) => (
                  <div key={project} className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm font-medium text-slate-300">
                    {project}
                  </div>
                ))}
              </div>
