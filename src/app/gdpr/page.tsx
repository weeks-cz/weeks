        ...
        <article className="section-container max-w-3xl">
          ...
          <div className="space-y-8">
            <section className="mb-12">
              <p className="data-label mb-2">01 / GDPR</p>
              <h2 className="font-display text-2xl font-bold text-white mb-4">Správce osobních údajů</h2>
              <p className="text-slate-300 leading-relaxed mb-4">
                Správcem Vašich osobních údajů je:
              </p>
              <div className="bg-night-800 p-6 rounded-lg border border-white/10">
                <p className="text-white font-semibold mb-2">DDM Praha 6 (Dům dětí a mládeže Praha 6)</p>
                ...
                <p className="text-slate-400 text-sm mt-2">DDM Praha 6 je organizátorem a správcem osobních údajů v rámci projektu Weeks.</p>
              </div>
            </section>

            <section className="mb-12">
              <p className="data-label mb-2">02 / GDPR</p>
              <h2 className="font-display text-2xl font-bold text-white mb-4">Jaké osobní údaje sbíráme</h2>
              <p className="text-slate-300 leading-relaxed mb-4" >
              ...
              <div className="bg-night-800 p-6 rounded-lg border border-white/10 mt-6">
                <p className="text-white font-medium mb-2">Důležitá informace</p>
            ...
            <section className="mb-12">
              ...
              <div className="space-y-4">
                <div className="bg-night-800 p-6 rounded-lg border border-white/10">
                  <h3 className="text-lg font-semibold text-white mb-2">Právo na přístup</h3>
                  <p className="text-slate-300 text-base">
                    Máte právo získat informaci o tom, jaké údaje o Vás zpracováváme.
                  </p>
                </div>
                <div className="bg-night-800 p-6 rounded-lg border border-white/10">
                  <h3 className="text-lg font-semibold text-white mb-2">Právo na opravu</h3>
                  <p className="text-slate-300 text-base">
                    Máte právo na opravu nepřesných nebo neúplných osobních údajů.
                  </p>
                </div>
                <div className="bg-night-800 p-6 rounded-lg border border-white/10">
                  <h3 className="text-lg font-semibold text-white mb-2">Právo na výmaz</h3>
                  <p className="text-slate-300 text-base">
                    Máte právo požadovat vymazání Vašich osobních údajů (právo "být zapomenut").
                  </p>
                </div>
                <div className="bg-night-800 p-6 rounded-lg border border-white/10">
                  <h3 className="text-lg font-semibold text-white mb-2">Právo na přenositelnost</h3>
                  <p className="text-slate-300 text-base">
                    Máte právo získat kopii Vašich údajů ve strukturovaném, běžně používaném formátu.
                  </p>
                </div>
                <div className="bg-night-800 p-6 rounded-lg border border-white/10">
                  <h3 className="text-lg font-semibold text-white mb-2">Právo vznést námitku</h3>
                  <p className="text-slate-300 text-base">
                    Máte právo vznést námitku proti zpracování Vašich osobních údajů.
                  </p>
                </div>
                <div className="bg-night-800 p-6 rounded-lg border border-white/10">
                  <h3 className="text-lg font-semibold text-white mb-2">Právo odvolat souhlas</h3>
                  <p className="text-slate-300 text-base">
            ...
            <section className="mb-12">
              <h2 className="font-display text-2xl font-bold text-white mb-4">8. Kontakt pro ochranu osobních údajů</h2>
              <p className="text-slate-300 leading-relaxed mb-4">
                Pro dotazy týkající se zpracování osobních údajů nás můžete kontaktovat:
              </p>
              <div className="bg-night-800 p-6 rounded-lg border border-white/10">
                <p className="text-slate-300 text-base">Email: info@weeks.cz</p>
              </div>
            </section>

            <section className="mb-12">
              <h2 className="font-display text-2xl font-bold text-white mb-4">9. Předávání údajů třetím stranám</h2>
              <p className="text-slate-300 leading-relaxed mb-4">
            ...
            <section className="mb-12">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-night-800 p-6 rounded-lg border border-white/10">
                  <h3 className="text-lg font-semibold text-white mb-2">Marketingové cookies</h3>
                  <p className="text-slate-300 text-base">
            ...
            <section className="mb-12">
              <h2 className="font-display text-2xl font-bold text-white mb-4">10a. Přibližná poloha podle IP adresy</h2>
              <p className="text-slate-300 leading-relaxed mb-4">
            ...
            <section className="mb-12">
              <h2 className="font-display text-2xl font-bold text-white mb-4">11. Zabezpečení osobních údajů</h2>
              <p className="text-slate-300 leading-relaxed mb-4">
            ...
            <section className="mb-12">
              <h2 className="font-display text-2xl font-bold text-white mb-4">12. Právo podat stížnost</h2>
              <p className="text-slate-300 leading-relaxed mb-4">
            ...
            <section className="mb-12">
              <h2 className="font-display text-2xl font-bold text-white mb-4">13. Změny zásad ochrany osobních údajů</h2>
              <p className="text-slate-300 leading-relaxed mb-4">
            ...
            <section className="mb-12">
              <h2 className="font-display text-2xl font-bold text-white mb-4">14. Kontakt</h2>
              <p className="text-slate-300 leading-relaxed mb-4">
                V případě jakýchkoliv dotazů ohledně těchto zásad nebo zpracování Vašich osobních
                údajů nás neváhejte kontaktovat:
              </p>
              <div className="bg-night-800 p-6 rounded-lg border border-white/10">
                <p className="text-white font-semibold mb-2">Weeks - projekt DDM Praha 6</p>
                <p className="text-slate-300 text-base mb-1">Email: info@weeks.cz</p>
                <p className="text-slate-300 text-base">
