        ...
        <article className="section-container max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-12">
              <h2 className="heading-3 text-ink mb-4">1. Správce osobních údajů</h2>
              ...
              <div className="bg-paper border border-ink/15 rounded-md p-6">
                ...
                <p className="text-ink-500 text-base mb-1">IČO: 24878511</p>
                <p className="text-ink-500 text-base mb-1">Projekt: Weeks – Letní příměstský tábor chytrých technologií</p>
                <p className="text-ink-500 text-base mb-1">Email: info@weeks.cz</p>
                <p className="text-ink-500 text-base">Web: weeks.cz/karlovy-vary</p>
              </div>
            </section>

            <section className="mb-12">
              <h2 className="heading-3 text-ink mb-4">2. Jaké osobní údaje sbíráme</h2>
              <p className="text-ink-500 mb-4">
              ...
              <div className="bg-primary-50 border border-primary-200/50 rounded-md p-6 mt-6">
            ...
            <section className="mb-12">
              <h2 className="heading-3 text-ink mb-4">3. Účel zpracování osobních údajů</h2>
            ...
            <section className="mb-12">
              <h2 className="heading-3 text-ink mb-4">4. Právní základ zpracování</h2>
            ...
            <section className="mb-12">
              <h2 className="heading-3 text-ink mb-4">5. Doba uchovávání údajů</h2>
              <ul className="list-disc pl-6 space-y-2 text-ink-500">
            ...
            <section className="mb-12">
              <h2 className="heading-3 text-ink mb-4">6. Vaše práva</h2>
              <p className="text-ink-500 mb-4">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.title} className="bg-paper p-6 rounded-md border border-ink/15">
                    <h3 className="text-lg font-semibold text-ink mb-2">{item.title}</h3>
                    <p className="text-ink-500 text-base">{item.text}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section className="mb-12">
              <h2 className="heading-3 text-ink mb-4">7. Jak uplatnit Vaše práva</h2>
              <p className="text-ink-500 mb-4">
            ...
            <section className="mb-12">
              <h2 className="heading-3 text-ink mb-4">8. Předávání údajů třetím stranám</h2>
              <p className="text-ink-500 mb-4">
            ...
            <section className="mb-12">
              <h2 className="heading-3 text-ink mb-4">9. Zabezpečení osobních údajů</h2>
              <ul className="list-disc pl-6 space-y-2 text-ink-500">
            ...
            <section className="mb-12">
              <h2 className="heading-3 text-ink mb-4">10. Cookies a sledovací technologie</h2>
              <div className="space-y-4">
                <div className="bg-paper p-6 rounded-md border border-ink/15">
                  <h3 className="text-lg font-semibold text-ink mb-2">Nezbytné cookies</h3>
                  <p className="text-ink-500 text-base">
                    Technické cookies nutné pro správné fungování webu. Tyto cookies nevyžadují souhlas.
                  </p>
                </div>
                <div className="bg-paper p-6 rounded-md border border-ink/15">
                  <h3 className="text-lg font-semibold text-ink mb-2">Analytické cookies</h3>
                  <p className="text-ink-500 text-base">
            ...
            <section className="mb-12">
              <h2 className="heading-3 text-ink mb-4">11. Právo podat stížnost</h2>
              <p className="text-ink-500 mb-4">
              ...
              <div className="bg-paper border border-ink/15 rounded-md p-6">
                ...
                <p className="text-ink-500 text-base mb-1">Pplk. Sochora 27</p>
                <p className="text-ink-500 text-base mb-1">170 00 Praha 7</p>
                <p className="text-ink-500 text-base mb-1">Web: www.uoou.cz</p>
                <p className="text-ink-500 text-base">Email: posta@uoou.cz</p>
              </div>
            </section>

            <section className="mb-12">
              <h2 className="heading-3 text-ink mb-4">12. Kontakt</h2>
              <div className="bg-primary-50 border border-primary-200/50 rounded-md p-6">
