...
export default function KVAboutPage() {
  return (
    <>
      ...
      <main>
        {/* Hero Section */}
        <section className="relative pt-32 pb-16 overflow-hidden bg-paper blueprint-grid">
          ...
          <div className="section-container relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <motion.div
                ...
                className="mb-8"
              >
                <Link href="/karlovy-vary" className="text-ink-500 hover:text-primary-600 transition-colors">
                  Domů
                </Link>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {values.map((value, index) => (
                  <motion.div
                    ...
                    className="p-6 bg-paper rounded-md"
                  >
          ...
          <div className="section-container">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              >
                ...
                <div className="w-16 h-16 bg-accent-100 rounded-md flex items-center justify-center mb-6">
          ...
          <div className="section-container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {teamMembers.map((member, index) => (
                ...
                >
                  <div className="w-12 h-12 bg-primary-600 border border-ink rounded-sm mx-auto mb-4 flex items-center justify-center">
