...
import { Printer, Clock, Users, MapPin, Calendar, ArrowRight } from 'lucide-react'
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 rounded-2xl p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3 text-gray-600">
                      <span className="text-2xl font-bold text-primary-600">{program.price.toLocaleString('cs-CZ')} Kč</span>
                    </div>
                  </div>
                </div>
                <div className="bg-gray-50 rounded-2xl p-6">
