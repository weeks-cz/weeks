...
const description =
  'Týdenní příměstské tábory pro děti 9–15 let v Praze a Karlových Varech. 3D tisk, IoT s Arduinem i virtuální realita, jeden lektor na pět dětí, oběd v ceně.'
