            ...
            <div className="flex flex-wrap items-center gap-6 md:gap-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-white">DDM Praha 6</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-white/10 backdrop-blur-sm flex items-center justify-center border border-white/10">
                  <span className="text-xs font-bold text-white">HW</span>
                </div>
                <div>
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-primary-500/30 backdrop-blur-sm flex items-center justify-center border border-primary-400/30">
                  <span className="text-xs font-bold text-white">10–15</span>
                </div>
                <div>
